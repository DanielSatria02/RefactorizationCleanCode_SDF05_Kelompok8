...
So because of that, that was the number one dilemma of the entire project, determining what 'c' is, which was not as straightforward as just saying it is the variable totalItem, because as per mentioned it ends up making the questions of "what is totalItem?" "Is it not quantity?" "Is it not subTotal". 